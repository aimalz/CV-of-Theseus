...
\begin{list}{}{\malzlist}
	...
	\deemph{\color{black} Project Scientist, LSST Interdisciplinary Network for Collaborative Computing (LINCC) Frameworks 2022--}
...
%	 Dark Energy (DE) and Informatics \& Statistics (IS) Science Collaborations (SCs) 
	\begin{list}{}{\malzlist}
		...
		\item Informatics \& Statistics SC (ISSC) Member 2019--; Exec. Council 2023--; Pub. Comm. 2024--% Charter Committee 2023, 
...
\end{list}
 \item PI, LSSTC Enabling Science 2019, DESC Cluster Lensing Mass Modeling Sprint Week% at RUB
...
\malzheading{Contributed Talks, Workshops \& Hackathon Participation}
...
%{Summer 2022}
%%\item \talk virtual Cluster Masses 2020/1 poster
%%\item \talk virtual SCMA VII poster
%\item 2021: \talk{The DESC Photometric Redshifts Working Group: Challenges \& Opportunities}
%{DESC Special Session}%, id. 443.05}
%{AAS \#237}
%{Spring 2020}
%%\item 2020: \talk Astro Hack Week (virtual)
%%\item 2020: \talk LSST-TVS/ISSC Hackathon (virtual)
...
%%{AAS \#233}
%%{Spring 2019}
%%\item 2018: \talk Chamonix, France, COIN Residential Program \# 6
...
%{Spring 2018}
%% ({\em chalkboard})
%%\item 2018: \talk Chania, Greece, COIN Residential Program \# 5
...
%{CMU}
%{Spring 2016}
%%\item 2016: \talk Astro Hack Week, University of California Berkeley
...
%{Chania, Greece}
%{Spring 2016}
%% \item 2015: \talk Astro Hack Week, NYU
...
\afterpage{\markboth{Alex I. Malz, curriculum vitae continued: \textbf{Service, Mentoring, \& Teaching}}{}}%
\clearpage
...
\nopagebreak\begin{list}{}{\malzlist}
	\item SOC member, Time Domain Needles in Rubin’s Haystack Hackathon \deemph{Harvard CfA, Spring 2024}
	\item SOC member, ISSC Collaboration Meeting \deemph{Harvard CfA, Spring 2024}
	\item CMU Outreach Committee member 2023-
	\item Session Facilitator, Rubin Project \& Community Workshop \deemph{Summers 2020, -21, -22, -23, -24}
...
%	\item Teacher, LSSTC Data Science Fellowship Program \deemph{Northwestern U., Fall 2022}
	...
	\item SOC+LOC member, Photometric LSST Astronomical Time-Series Classification Challenge (PLAsTiCC) \deemph{NYU, Spring 2018}
	\item Hackathon Leader, Astro Hack Week \deemph{UC Berkeley, Fall 2017}
	\item LOC member, Astro Hack Week \deemph{NYU, Fall 2015}
	\item Reviewer, NSF Astronomy and Astrophysics Research Grants (AAG) \deemph{dates redacted for confidentiality}
...
\begin{list}{}{\malzlist}
	\item 2024--: Jenny Dong \& Andrew Yuan; CMU Stats \& Data Science, BS \deemph{2027}
	\item 2024--: Rachel Ouyang; CMU Physics$\rightarrow$UChicago Physics, BS \deemph{2027}
	\item 2023--: Alice Crafford; CMU Physics, BS \deemph{2025}
	\item 2021-22: Natalia Stylianou; U. of Leicester, BS \& MS \deemph{2022}; Oxford U., PhD. \deemph{2025}
	\item 2021-22: Nicola Hunfeld; RUB Astronomy, MS \deemph{2022}
...
\begin{list}{}{\malzlist}
	\item Building a Phys. Understanding of Galaxy Evol. with Data-driven Astro. \deemph{KITP-CCA, Winter 2023}
...
\begin{list}{}{\malzlist}
	\item STEM@CMU Panelist, Chief Science Officer Leadership training program \deemph{Fall 2023}
	...
	\item Contestant, Dance Your Ph.D. \deemph{\href{youtu.be/vKs3PYqZWg8}{tinyurl.com/aimalz-dance-your-phd} \deemph{Winter 2018-19}} %(01/2019)
	\begin{list}{}{\malzlist}
	...
	\begin{list}{}{\malzlist}
		\item \deemph{Created and implemented tie-dye-based activities teaching astronomy concepts \href{https://tinyurl.com/astro-tie-dye}{tinyurl.com/astro-tie-dye}}% for multiple age groups
	\end{list}
\end{list}
