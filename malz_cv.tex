...
\texttt{aimalz@astro.ruhr-uni-bochum.de}               & & Universit{\"a}tstra{\ss}e 150\\%[1ex]
 \url{https://aimalz.github.io/} & & 44801 Bochum, Germany\\%[1ex]
\end{tabular}\vspace{1ex} 

\malzheading{Appointments}
\begin{list}{}{\malzlist}
...
\malzheading{Education \& Academic Fellowships}
\begin{list}{}{\malzlist}
\item
PhD 2020, Physics, New York University (NYU) Graduate School of Arts and Sciences (GSAS)
	\begin{list}{}{\malzlist}
		...
		\item \deemph{GSAS Ted Keusseff Fellow, 2018-19; GSAS MacCracken Fellow, 2014-18}
	\end{list}{}
\item
MS 2014, Astronomy \& Astrophysics, Pennsylvania State University (PSU) \deemph{Braddock/Roberts Fellow 2012-13}
\item
BS 2011, Physics \& History, California Institute of Technology (Caltech) \deemph{President's Scholar, 2006-11}
\end{list}
...
\malzheading{Professional Service}\nopagebreak\begin{list}{}{\malzlist}
	...
	\item Tutorial Co-organizer, Bayesian Deep Learning for Cosmology and Gravitational Waves \deemph{(Astroparticle and Cosmology Laboratory Université de Paris, Winter 2020)}
...
\begin{list}{}{\malzlist}
\item Judge, New York City Science and Engineering Fair finals event \deemph{Spring 2021}%(03/2021)
\item Juror, German Young Physicists' Tournament North Rhine-Westphalia \deemph{Winter 2021}%(02/2021)
\item Contestant, Dance Your Ph.D. \deemph{\href{https://youtu.be/vKs3PYqZWg8}{youtu.be/vKs3PYqZWg8}, Winter 2019} %(01/2019)
  \begin{list}{}{\malzlist}
  \item \deemph{Produced, directed, choreographed, and danced an entertaining explanation of Malz \& Hogg (2021)}
    \end{list}
\item Math Circle Speaker at Bridge to Enter Advanced Mathematics \deemph{\href{https://beammath.org}{beammath.org}, Summer 2018}% (07/2018)
  \begin{list}{}{\malzlist}
  ...
  \end{list}
\item Judge, New York City Science and Engineering Fair finals event \deemph{Spring 2018}%(03/2018)
...
\item Outreach Developer \& Facilitator, PSU AstroFest \deemph{Summers 2012, 2013, 2014}
  \begin{list}{}{\malzlist}
