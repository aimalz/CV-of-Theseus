...
\begin{tabular}{lllll}
\noindent\textbf{\Large Alex I. Malz}            & & {\small McWilliams Center for Cosmology} & & {\url{https://github.com/aimalz}} \\%[1ex]
\noindent ORCiD 0000-0002-8676-1622\deemph{\today} & & {\small Carnegie Mellon University (CMU)} & & \texttt{aimalz@nyu.edu}    \\%\\Ruhr-Universit{\"a}t Bochum (RUB)}\\%[1ex]
...
\malzheading{Professional Service \& Organizational Roles}\nopagebreak\begin{list}{}{\malzlist}
	\item Teacher, LSSTC Data Science Fellowship Program \deemph{(Northwestern U., Fall 2022)}
	\item Hackathon Leader, From Quarks to Cosmos \deemph{(Carnegie Mellon U., Summer 2021)}
...
\begin{list}{}{\malzlist}
	...
	{AAS \#241}
	{Spring 2023}
\item 2022: \talk{Are classification metrics good proxies for SN Ia cosmological constraining power?}{Boom! A Workshop on Explosive Transients with LSST}{U. Illinois Urbana-Champaign}{Summer 2022}
...
\end{list}
%
\afterpage{\markboth{Alex I. Malz, curriculum vitae continued: \textbf{Supervision, Outreach \& Teaching}}{}}%
\clearpage

 \malzheading{Research Supervision \& Mentoring}
\begin{list}{}{\malzlist}
	\item 2021--: Natalia Stylianou; U. of Leicester, BS \& MS \deemph{2022}; Oxford U., PhD. \deemph{2025}
